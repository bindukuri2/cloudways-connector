...
const inputShape = {
    workspaceRoot: z
        .string()
        .min(1)
        .describe("Absolute path to the user's workspace root. The detector reads files in read-only mode and never executes anything from disk."),
};
export function registerDetectProject(server) {
...
//# sourceMappingURL=detect_project.js.map